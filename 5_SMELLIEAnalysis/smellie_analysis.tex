...
\begin{figure}
    ...
    {Summary of scintillator extinction length measurements made by SMELLIE, with comparisons to the ex-situ measurements made by B. Tam~\cite{} % CITE!
    and the current \SI{2.2}{\gpl} optics model used in \texttt{RAT}.}
...
The challenge with this analysis approach is that it relies on the use of SMELLIE simulations to derive results. Because
